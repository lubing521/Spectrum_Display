...
//	showhz(105+80*4, 30, 9,80);
//	showhz(105+80*5, 30, 10,80);
...
//	showhz(200,170, 18,64); //大脉冲
//	showhz(200+64*1,170,21,64);
//	showhz(200+64*2,170, 22,64);
//	showhz(200,250, 20,64);//中脉冲
//	showhz(200+64*1, 250, 21,64);
//	showhz(200+64*2, 250, 22,64);
//	showhz(200,250+80, 19,64);//小脉冲
//	showhz(200+64*1, 250+80, 21,64);
//	showhz(200+64*2, 250+80, 22,64);
//	LCD_ShowChar(200+64*3,170, ':',64);
//	LCD_ShowChar(200+64*3,170+80, ':',64);
//	LCD_ShowChar(200+64*3,170+80*2, ':',64);
//	if(small/100!=0){
//		LCD_ShowChar(200+64*6,170+80*2, small/100+0x30,64);
//		LCD_ShowChar(200+64*6+32*1,170+80*2, small/10%10+0x30,64);
//		LCD_ShowChar(200+64*6+32*2,170+80*2, small%10+0x30,64);
//	}
//	else{
//		if(small/10%10!=0){
//			LCD_ShowChar(200+64*6+32*1,170+80*2, small/10%10+0x30,64);
...
//	}
//	if(medium/100!=0){
//		LCD_ShowChar(200+64*6,170+80*1, medium/100+0x30,64);
//		LCD_ShowChar(200+64*6+32*1,170+80*1, medium/10%10+0x30,64);
//		LCD_ShowChar(200+64*6+32*2,170+80*1, medium%10+0x30,64);
//	}
//	else{
//		if(medium/10%10!=0){
//			LCD_ShowChar(200+64*6+32*1,170+80*1, medium/10%10+0x30,64);
...
//	}
//	if(big/100!=0){
//		LCD_ShowChar(200+64*6,170+80*0, big/100+0x30,64);
//		LCD_ShowChar(200+64*6+32*1,170+80*0, big/10%10+0x30,64);
//		LCD_ShowChar(200+64*6+32*2,170+80*0, big%10+0x30,64);
//	}
//	else{
//		if(big/10%10!=0){
//			LCD_ShowChar(200+64*6+32*1,170+80*0, big/10%10+0x30,64);
...
void showaxis(){
	uint16_t i;
	for(i=0;i<6;i++) Gui_Draw_Line(stx-50,sty+i, endx+1, sty+i, WHITE_4_4);
	for(i=0;i<6;i++) Gui_Draw_Line(stx+i,sty+50, stx+i, endy+1, WHITE_4_4);
	for(i=0;i<12;i++) Gui_Draw_Line(stx+3,endy-10+i, stx+3-5-i, endy-10+20+i, WHITE_4_4);
	for(i=0;i<12;i++) Gui_Draw_Line(stx+3,endy-10+i, stx+3+5+i, endy+20+i-10, WHITE_4_4);
	for(i=0;i<12;i++) Gui_Draw_Line(endx+10-i,sty+3, endx-20-i+10, sty+3-5-i, WHITE_4_4);
	for(i=0;i<12;i++) Gui_Draw_Line(endx+10-i,sty+3, endx-20-i+10, sty+3+5+i, WHITE_4_4);
...
//		if(i==50){
//			LCD_ShowChar(stx-5-16*2, sty-40*i/50-16,i/10+0x30,32);
//			LCD_ShowChar(stx-5-16*1, sty-40*i/50-16,i%10+0x30,32);
//		}
//		else{
//			LCD_ShowChar(stx-5-16*3, sty-40*i/50-16,i/100+0x30,32);
//			LCD_ShowChar(stx-5-16*2, sty-40*i/50-16,i/10%10+0x30,32);
//			LCD_ShowChar(stx-5-16*1, sty-40*i/50-16,i%10+0x30,32);
//		}
//	}
